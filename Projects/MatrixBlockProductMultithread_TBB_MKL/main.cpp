...
int main(){
    int n=1000;//Order of square matrices A and B to compute the product
...
void BlockMatrixProduct (int n,double* A,double* B,double* C){
    ...
    tbb::parallel_invoke([&]{fun1(k, A11, A12, B11, B21, C11);},
                         [&]{fun2(k, A11, A12, B12, B22, C12);},
                         [&]{fun3(k, A21, A22, B11, B21, C21);},
                         [&]{fun4(k, A21, A22, B12, B22, C22);});
    
    /*
    tbb::task_group g;
    g.run([&]{fun1(k, A11, A12, B11, B21, C11);});
    g.run([&]{fun2(k, A11, A12, B12, B22, C12);});
    g.run([&]{fun3(k, A21, A22, B11, B21, C21);});
    g.run([&]{fun4(k, A21, A22, B12, B22, C22);});
    g.wait();
