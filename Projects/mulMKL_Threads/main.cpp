...
*   Copyright(C) 2012-2014 Intel Corporation. All Rights Reserved
 https://github.com/avacore1337/thesis/blob/master/code/mkl/dgemm_threading_effect_example.c
********************************************************************************
...
int main()
{
    ...
    std::cout<<"Making the run of matrix product with DGEMM by default"<<std::endl;
    s_initial = dsecnd();
    ...
    std::cout<<"dgemm completed in "<<s_elapsed * 1000<<" milliseconds"<<"\n\n\n";
